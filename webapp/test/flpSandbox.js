			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pokedexdemo-display": {
								"semanticObject": "pokedexdemo",
								"action": "display",
								"description": "Ein Pokedex",
								"title": "Pokedex",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pokedex.demo",
									"url": sap.ui.require.toUrl("pokedex/demo")
								}
							}
						}
					}
